(function () { function r (e, n, t) { function o (i, f) { if (!n[i]) { if (!e[i]) { const c = typeof require === 'function' && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); const a = new Error("Cannot find module '" + i + "'"); throw a.code = 'MODULE_NOT_FOUND', a } const p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { const n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = typeof require === 'function' && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  ...
  2: [function (require, module, exports) {
    ...
    const _color = _interopRequireDefault(require('@jiaminghi/color'))

    const _bezierCurve = _interopRequireDefault(require('@jiaminghi/bezier-curve'))

    const _util = require('../plugin/util')

    const _graphs = _interopRequireDefault(require('../config/graphs'))

    const _graph = _interopRequireDefault(require('./graph.class'))
 ...
 */
  ...
  }, { '../config/graphs': 5, '../plugin/util': 8, './graph.class': 3, '@babel/runtime/helpers/classCallCheck': 12, '@babel/runtime/helpers/defineProperty': 13, '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/toConsumableArray': 20, '@jiaminghi/bezier-curve': 25, '@jiaminghi/color': 27 }],
  3: [function (require, module, exports) {
    ...
    const _style = _interopRequireDefault(require('./style.class'))

    const _transition = _interopRequireDefault(require('@jiaminghi/transition'))
 ...
 */
    ...
    Graph.prototype.hoverCheckProcessor = function (position, _ref) {
      ...
      if (graphCenter) {
        ...
        if (scale) {
          position = (0, _util.getScalePointPos)(scale.map(function (s) {
            return 1 / s
          }), position, graphCenter)
        }
        if (translate) {
          position = (0, _util.getTranslatePointPos)(translate.map(function (v) {
            return v * -1
          }), position)
        }
      }
 ...
 */
  ...
  }, { '../plugin/util': 8, './style.class': 4, '@babel/runtime/helpers/asyncToGenerator': 11, '@babel/runtime/helpers/classCallCheck': 12, '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/toConsumableArray': 20, '@babel/runtime/helpers/typeof': 21, '@babel/runtime/regenerator': 22, '@jiaminghi/transition': 29 }],
 ...
 */
    ...
    Style.prototype.colorProcessor = function (style) {
      ...
      const processor = reverse ? _color.getColorFromRgbValue : _color.getRgbaValue
 ...
 */
    ...
    Style.prototype.getStyle = function () {
      const clonedStyle = (0, _util.deepClone)(this, true)
      this.colorProcessor(clonedStyle, true)
      return clonedStyle
    }
  }, { '../plugin/util': 8, '@babel/runtime/helpers/classCallCheck': 12, '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/toConsumableArray': 20, '@jiaminghi/color': 27 }],
 ...
 */
  ...
  }, { '../plugin/canvas': 7, '../plugin/util': 8, '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/slicedToArray': 19, '@babel/runtime/helpers/toConsumableArray': 20, '@jiaminghi/bezier-curve': 25 }],
  6: [function (require, module, exports) {
    ...
    exports.default = _default
  }, { './class/crender.class': 2, './config/graphs': 5, '@babel/runtime/helpers/interopRequireDefault': 14 }],
 ...
 */
    ...
    exports.default = _default
  }, { '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/toConsumableArray': 20 }],
 ...
 */
    ...
    exports.default = _default
  }, { '@babel/runtime/helpers/interopRequireDefault': 14, '@babel/runtime/helpers/slicedToArray': 19, '@babel/runtime/helpers/toConsumableArray': 20, '@babel/runtime/helpers/typeof': 21 }],
  ...
  19: [function (require, module, exports) {
    const arrayWithHoles = require('./arrayWithHoles')

    const iterableToArrayLimit = require('./iterableToArrayLimit')

    const nonIterableRest = require('./nonIterableRest')
  ...
  }, { './arrayWithHoles': 9, './iterableToArrayLimit': 16, './nonIterableRest': 17 }],
  20: [function (require, module, exports) {
    const arrayWithoutHoles = require('./arrayWithoutHoles')

    const iterableToArray = require('./iterableToArray')

    const nonIterableSpread = require('./nonIterableSpread')
  ...
  }, { './arrayWithoutHoles': 10, './iterableToArray': 15, './nonIterableSpread': 18 }],
 ...
 */
    ...
    function getTwoPointDistance (_ref, _ref2) {
      const _ref3 = _slicedToArray(_ref, 2)
      const ax = _ref3[0]
      const ay = _ref3[1]

      const _ref4 = _slicedToArray(_ref2, 2)
      const bx = _ref4[0]
      const by = _ref4[1]
 ...
 */
    ...
    function getSymmetryPoint (point, centerPoint) {
      ...
      const _centerPoint = _slicedToArray(centerPoint, 2)
  ...
  27: [function (require, module, exports) {
    ...
    const _keywords = _interopRequireDefault(require('./config/keywords'))
 ...
 */
    ...
    function fade (color) {
      ...
      const rgbValue = getRgbValue(color)
      if (!rgbValue) return false
      const rgbaValue = [].concat(_toConsumableArray(rgbValue), [percent / 100])
      return getColorFromRgbValue(rgbaValue)
    }
 ...
 */
    ...
    function checkParams (tBC) {
      ...
      const stateType = _typeof(endState)
 ...
 */
    ...
    function getBezierCurveTState (_ref, t) {
      ...
      const _ref2$ = _slicedToArray(_ref2[0], 2)
      const p0 = _ref2$[1]
      const _ref2$2 = _slicedToArray(_ref2[1], 2)
      const p1 = _ref2$2[1]
      const _ref2$3 = _slicedToArray(_ref2[2], 2)
      const p2 = _ref2$3[1]
      const _ref2$4 = _slicedToArray(_ref2[3], 2)
      const p3 = _ref2$4[1]
